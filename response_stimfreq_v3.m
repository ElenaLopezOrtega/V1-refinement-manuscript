function [mean_PYY_f, mean_PYY_f_resp, dff_cells_oris_resp, dff_cells_oris_resp_orth, idx, mean_PYY_cnt, mean_PYY_cnt_resp] = response_stimfreq_v3 (PYY,PYY_Gr, f, f_cnt, dff_cells_oris_pref_ori, dff_cells_oris_orth_ori)
...
% threshold = PYY_G_f_mean + 1*PYY_G_f_stdv; %Z-score of 1
...
dff_cells_oris_resp_orth = dff_cells_oris_orth_ori(:,idx);
